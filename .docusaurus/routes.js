...
export default [
  {
    ...
    component: ComponentCreator('/__docusaurus/debug', 'f49'),
    exact: true
  },
  {
  ...
  },
  {
    ...
    component: ComponentCreator('/__docusaurus/debug/content', 'b5c'),
    exact: true
  },
  {
    path: '/__docusaurus/debug/globalData',
    component: ComponentCreator('/__docusaurus/debug/globalData', '759'),
    exact: true
  },
  {
    path: '/__docusaurus/debug/metadata',
    component: ComponentCreator('/__docusaurus/debug/metadata', 'e76'),
    exact: true
  },
  {
    path: '/__docusaurus/debug/registry',
    component: ComponentCreator('/__docusaurus/debug/registry', 'd4a'),
    exact: true
  },
  {
    path: '/__docusaurus/debug/routes',
    component: ComponentCreator('/__docusaurus/debug/routes', 'ee7'),
    exact: true
  },
  {
    path: '/blog',
  ...
  {
    path: '/docs',
    component: ComponentCreator('/docs', 'fb8'),
    routes: [
      {
      ...
      {
        path: '/docs/Templates/what-is',
        component: ComponentCreator('/docs/Templates/what-is', '71f'),
        exact: true,
        sidebar: "tutorialSidebar"
      }
    ]
